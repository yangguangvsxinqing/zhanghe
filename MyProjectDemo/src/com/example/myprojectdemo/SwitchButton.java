...
//		setThumbDrawable(ContextCompat.getDrawable(getContext(), thumbDrawableRes));//add by zhanghe
	}
...
//		setBackDrawable(ContextCompat.getDrawable(getContext(), backDrawableRes));//add by zhanghe
	}
...
//		setBackColor(ContextCompat.getColorStateList(getContext(), backColorRes));//add by zhanghe
	}
...
//		setThumbColor(ContextCompat.getColorStateList(getContext(), thumbColorRes));//add by zhanghe
	}
