...
public class SvLteController {
     ...
     */
    public static final boolean is4GDataEnabled(Context context) {
     ...
     */
    public static final boolean is4GDataOnlyMode(Context context) {
    ...
    private static final int getSvlteRatMode(Context context) {
