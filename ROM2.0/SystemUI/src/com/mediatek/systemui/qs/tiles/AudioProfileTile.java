...
public class AudioProfileTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.visible = true;
        state.value = true;////fineos add by zhanghe 
    ...
    private void loadEnabledProfileResource(Scenario scenario) {
		...
		//fineos add by zhanghe begin
        int  themeColor= ColorHelper.getColor(mContext.getResources(), R.color.systemui_qs_color);
        Log.i("zhanghehe","themeColor==="+Integer.toHexString(themeColor));
		ColorFilter filter = new PorterDuffColorFilter(themeColor, PorterDuff.Mode.SRC_ATOP);
        //fineos add by zhanghe begin
		int audioState;
        switch (scenario) {
        case GENERAL:
            mNormalProfileIcon.setImageResource(R.drawable.ic_qs_normal_profile_enable);
    		mNormalProfileIcon.setColorFilter(filter);//fineos add by zhanghe 
            mAudioState = R.drawable.ic_qs_normal_profile_enable;
            break;
        case MEETING:
            mMettingProfileIcon.setImageResource(R.drawable.ic_qs_meeting_profile_enable);
            mMettingProfileIcon.setColorFilter(filter);//fineos add by zhanghe 
            mAudioState = R.drawable.ic_qs_meeting_profile_enable;
            break;
        case OUTDOOR:
            mOutdoorSwitchIcon.setImageResource(R.drawable.ic_qs_outdoor_profile_enable);
            mOutdoorSwitchIcon.setColorFilter(filter);//fineos add by zhanghe 
            mAudioState = R.drawable.ic_qs_outdoor_profile_enable;
            break;
        case SILENT:
            mMuteProfileIcon.setImageResource(R.drawable.ic_qs_mute_profile_enable);
            mMuteProfileIcon.setColorFilter(filter);//fineos add by zhanghe 
            mAudioState = R.drawable.ic_qs_mute_profile_enable;
            break;
        case CUSTOM:
