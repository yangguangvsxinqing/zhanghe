...
///FineOS Notificaiton qs start
    private static final int QS_MOBILE_DISABLE = R.drawable.fineos_ic_qs_mobile_off;
    private static final int QS_MOBILE_ENABLE = R.drawable.fineos_ic_qs_mobile_on;
...
///FineOS Notificaiton qs end
    ...
    public static final String ACTION_DATA_USAGE_ENABLE_MOBILE_CHANGHE     = "com.android.systemui.action.data.usage.enable.mobile";////fineos add by zhanghe
    ...
    protected void handleClick() {
        ...
        //fineos add by zhanghe begin 20150929
    	Intent intent = new Intent(ACTION_DATA_USAGE_ENABLE_MOBILE_CHANGHE);
    	boolean mdataStatus = !mState.connected;
    	intent.putExtra("dataStatus", mdataStatus);
    	mContext.sendBroadcast(intent);
    	//fineos add by zhanghe end 20150929
    }
///FineOS Notificaiton qs start
    @Override
