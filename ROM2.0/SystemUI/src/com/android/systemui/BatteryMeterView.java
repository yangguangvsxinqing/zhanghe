...
public class BatteryMeterView extends View implements DemoMode,
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFramePaint.setColor(res.getColor(R.color.batterymeter_frame_color_fineos));
        mFramePaint.setDither(true);
        mFramePaint.setStrokeWidth(0);
        mFramePaint.setStyle(Paint.Style.FILL_AND_STROKE);
	//fineos STATUSBAR_ICON_COLOR_SUPPORT start
	mFrameColor = res.getColor(R.color.batterymeter_frame_color_fineos);
	//fineos STATUSBAR_ICON_COLOR_SUPPORT end
       ...
       // mChargeColor = getResources().getColor(R.color.batterymeter_charge_color);
		mChargeColor = getResources().getColor(R.color.batterymeter_charge_color_fineos);
    ...
    public void draw(Canvas c) {
		...
		/* fineos STATUSBAR_ICON_COLOR_SUPPORT test
		tracker.level = 20;
		//tracker.plugged = true;
		//tracker.plugType = 2;
		//tracker.status = 2;
		*/
		...
		if(level < 15){
        	...
        	int origColor = tracker.plugged ? mChargeColor : getColorForLevel(level);
		if(level < 15){
			origColor = getColorForLevel(level);
			mBatteryPaint.setColor(origColor);
		}else{
			mBatteryPaint.setColor(getFilteredColor(origColor));
		}
	}
	...
	if(!mSetColor){
		...
		mFramePaint.setColor(getFilteredColor(mFrameColor));
	}
		...
		// fineos STATUSBAR_ICON_COLOR_SUPPORT start
            if (false){ //boltPct <= BOLT_LEVEL_THRESHOLD) {
		// fineos STATUSBAR_ICON_COLOR_SUPPORT end
	...
	public void setIconColor(int color){
		if(mFramePaint != null){
			...
			//mWarningTextPaint.setColor(color);
			//mBoltPaint.setColor(color);
			invalidate();
		}
	}
	public int getFilteredColor(int origColor){
		int color1 = origColor & 0xFF000000;
		int color2 = mColorFilter & 0x00FFFFFF;
		int color3 = color1 | color2;
		return color3;
	}
	public void printColor(String colorName, int colorValue){
		String colorString = colorName + " = 0x" + Integer.toHexString(colorValue);
		//Log.e("yfm", colorString);
	}
       //fineos STATUSBAR_ICON_COLOR_SUPPORT end
}
