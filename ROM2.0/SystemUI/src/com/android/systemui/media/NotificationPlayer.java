                                ...
                                if (mAudioManagerWithAudioFocus == null) {
                                    ...
                                    if (mCmd.looping) {
                                        ...
                                        audioManager.requestAudioFocus(null,
                                                ...
                                                AudioManager.AUDIOFOCUS_GAIN); //Sync by nixionglin like HQ00996623
                                    } else {
                                        /// M: Fix music can adjust to original volume when SMS end ring.
                                        audioManager.requestAudioFocus(null,
                                                AudioAttributes.toLegacyStreamType(mCmd.attributes),
                                                AudioManager.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK); //Sync by nixionglin like HQ00996623
                                    }
                        ...
                        if (mPlayer != null) {
                            ...
                            synchronized (mPlayerLock) {
                                ...
                                synchronized (mQueueAudioFocusLock) {
                                    if (mAudioManagerWithAudioFocus != null) {
                                        /// M: Fix music can adjust to original volume when SMS end ring.
                                        mAudioManagerWithAudioFocus.abandonAudioFocus(null); //Sync by nixionglin like HQ00996623
