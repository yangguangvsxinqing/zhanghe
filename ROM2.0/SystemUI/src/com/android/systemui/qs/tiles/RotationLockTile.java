...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
	...
	///M:[HQ_BOWAY_SYSTEMUI] modify{@
	private final ResourceIcon mPortraitToAutoExt =
	        new ResourceIcon(R.drawable.ic_qs_portrait_to_auto_rotate);
	private final ResourceIcon mAutoToPortraitExt =
	        new ResourceIcon(R.drawable.ic_qs_portrait_from_auto_rotate);
	private final ResourceIcon mLandscapeToAutoExt =
	        new ResourceIcon(R.drawable.ic_qs_landscape_to_auto_rotate);
	private final ResourceIcon mAutoToLandscapeExt =
	        new ResourceIcon(R.drawable.ic_qs_landscape_from_auto_rotate);
	///@}
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (FeatureOption.HQ_BOWAY_SYSTEMUI){
	        ...
	        if (rotationLocked) {
	            ...
	            icon = portrait ? mAutoToPortraitExt : mAutoToLandscapeExt;
	        } else {
	            state.label = mContext.getString(R.string.quick_settings_rotation_unlocked_label);
	            icon = portrait ? mPortraitToAutoExt : mLandscapeToAutoExt;
	        }
	        state.icon = icon;
        } else {
