...
public class HotspotTile extends QSTile<QSTile.BooleanState> {
	...
	///M:[HQ_BOWAY_SYSTEMUI] modify{@
	private final ResourceIcon mHotspotEnable =
	        new ResourceIcon(R.drawable.ic_qs_hotspot_on);
	private final ResourceIcon mHotspotDisable =
	        new ResourceIcon(R.drawable.ic_qs_hotspot_off);
	///@}
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
    	...
    	///M:[HQ_BOWAY_SYSTEMUI] modify{@
        if (FeatureOption.HQ_BOWAY_SYSTEMUI){
			state.icon = state.visible && state.value ? mHotspotEnable : mHotspotDisable;
        } else {
