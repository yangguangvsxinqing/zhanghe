...
public class LocationTile extends QSTile<QSTile.BooleanState> {
    ...
    ///M:[HQ_BOWAY_SYSTEMUI] modify{@
	private final ResourceIcon mLocationEnable =
	        new ResourceIcon(R.drawable.ic_qs_location_on);
		private final ResourceIcon mLocationDisable =
	        new ResourceIcon(R.drawable.ic_qs_location_off);
	///@}
