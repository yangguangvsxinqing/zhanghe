...
//import com.huaqin.common.featureoption.FeatureOption;
/** Quick settings tile: Control flashlight   HQ-FlashLight  **/
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    ///M:[HQ_BOWAY_SYSTEMUI] modify{@
    private final ResourceIcon mFlashlightEnable =
	new ResourceIcon(R.drawable.ic_qs_flashlight_on);
    private final ResourceIcon mFlashlightDisable =
	new ResourceIcon(R.drawable.ic_qs_flashlight_off);
    ///@}
	...
	///M:[HQ_BOWAY_SYSTEMUI] modify{@
        if (FeatureOption.HQ_BOWAY_SYSTEMUI){
			final ResourceIcon icon = state.value ? mFlashlightEnable : mFlashlightDisable;
			state.icon = icon;
        } else {
    ...
    @Override
    public void onFlashlightStatusUpdate(boolean enable) {
        refreshState(enable);
    }
