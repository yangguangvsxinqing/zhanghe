...
public class NotificationStackScrollLayout extends ViewGroup
	...
	///M:[HQ_BOWAY_SYSTEMUI] modify{@
	private OnDismissStateChangeListener mDismissButtonStateChangeListener;
	///@}
    ...
    public void goToFullShade(long delay) {
		...
		///M:[HQ_BOWAY_SYSTEMUI] modify{@
		if (FeatureOption.HQ_BOWAY_SYSTEMUI && mDismissButtonStateChangeListener != null){
		    mDismissButtonStateChangeListener.onStateChange(false);
		}  
    	///@}
    ...
    public void updateDismissView(boolean visible) {
		///M:[HQ_BOWAY_SYSTEMUI] modify{@
		if (FeatureOption.HQ_BOWAY_SYSTEMUI && mDismissButtonStateChangeListener != null){
		    mDismissButtonStateChangeListener.onStateChange(visible);
		}  
    	///@}
    ...
    ///M:[HQ_BOWAY_SYSTEMUI] modify{@
    public void setDismissStateChangeListener(OnDismissStateChangeListener listener){
        mDismissButtonStateChangeListener=listener;
    }

    public interface OnDismissStateChangeListener{
