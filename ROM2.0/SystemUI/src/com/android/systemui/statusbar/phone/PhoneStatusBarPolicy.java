...
// add by gongpeicai for show outdoor icon HQ_STATUSBAR_PROFILE_ICON @{
...
public class PhoneStatusBarPolicy {
	...
	// add by gongpeicai for show outdoor icon HQ_STATUSBAR_PROFILE_ICON @{
        AudioProfileManager mProfileManager = (AudioProfileManager)mContext.getSystemService(Context.AUDIO_PROFILE_SERVICE);
        String activeProfileKey = mProfileManager.getActiveProfileKey();
	// add by gongpeicai for show outdoor icon HQ_STATUSBAR_PROFILE_ICON @}
	 ...
	 // add by gongpeicai for show outdoor icon HQ_STATUSBAR_PROFILE_ICON @{
        if (mProfileManager.getProfileKey(Scenario.OUTDOOR).equals(activeProfileKey)) { 
            //android.util.Log.e("gongpeicai", "updateVolumeZen  outdoor ");
            volumeVisible = true;
            volumeIconId = R.drawable.stat_sys_zen_outdoor;
            volumeDescription = mContext.getString(R.string.accessibility_ringer_vibrate);
        }
       // add by gongpeicai for show outdoor icon HQ_STATUSBAR_PROFILE_ICON @}
