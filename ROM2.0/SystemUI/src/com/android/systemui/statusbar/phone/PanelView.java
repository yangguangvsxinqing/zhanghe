...
/**[HQ_LAUNCHER_EXPAND_NOTIFICATION] modify start*/
import android.content.Intent;
import android.content.IntentFilter;
import android.content.BroadcastReceiver;
/**[HQ_LAUNCHER_EXPAND_NOTIFICATION] modify end*/
...
/**[HQ_LAUNCHER_EXPAND_NOTIFICATION] modify start*/
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG,"LAUNCHER_EXPAND_NOTIFICATION: onReceive to expand");
            expand();
        }
    };
/**[HQ_LAUNCHER_EXPAND_NOTIFICATION] modify end*/
...
/**[HQ_LAUNCHER_EXPAND_NOTIFICATION] modify start*/
        ...
        filter.addAction("LAUNCHER_EXPAND_NOTIFICATION");
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
				...
				if(fineUtilities.useFineOSlideKeyguard()&&isKeyguardShowing){
    ...
    protected boolean isScrolledToBottom() {
	   ///FineOS xuqian add starts  to disable up gesture when keyguard showing
		...
		if(fineUtilities.useFineOSlideKeyguard()&&isKeyguardShowing){
    		...
    		Log.v(TAG,"ro.fineos.framework is true...");
    		return false ;
		}else {
    		return true;
    	}
