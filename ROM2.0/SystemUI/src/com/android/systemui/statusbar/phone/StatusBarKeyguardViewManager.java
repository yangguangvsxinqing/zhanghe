...
public class StatusBarKeyguardViewManager {
    ...
    private static boolean mKeyguardShowing;
    ...
    public void registerStatusBar(PhoneStatusBar phoneStatusBar,
        ...
        if(SystemProperties.getBoolean("ro.fineos.framework", false)){
        	
        	mBouncer = new KeyguardBouncerHQ(mContext, mViewMediatorCallback, mLockPatternUtils,
                    mStatusBarWindowManager, container);
        	Slog.v(TAG,"Use fineos bouncer.....");
        }else{
    ...
    public void show(Bundle options) {
        ...
        mShowing = true;
        mKeyguardShowing = true ;  //xuqian add
    ...
    public void hide(long startTime, final long fadeoutDuration) {
        ...
        mShowing = false;
        mKeyguardShowing = false ; //xuqian add
