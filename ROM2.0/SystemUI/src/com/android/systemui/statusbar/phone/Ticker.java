...
public abstract class Ticker {
	...
	public void setIconColor(int color){
		if(mTextSwitcher != null){
			TextView text0 = (TextView)mTextSwitcher.getChildAt(0);
			TextView text1 = (TextView)mTextSwitcher.getChildAt(1);
			ImageView icon0 = (ImageView)mIconSwitcher.getChildAt(0);
			ImageView icon1 = (ImageView)mIconSwitcher.getChildAt(1);
			if(text0 != null && text1 != null && icon0 != null && icon1 != null){
				text0.setTextColor(color);
				text1.setTextColor(color);
				icon0.setColorFilter(color);
				icon1.setColorFilter(color);
			}
		}
	}
       //fineos STATUSBAR_ICON_COLOR_SUPPORT end
