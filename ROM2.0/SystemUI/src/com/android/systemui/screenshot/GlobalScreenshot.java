...
import com.mediatek.storage.StorageManagerEx;//add by dickie for screenshot save the image in the selected storage
...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        mScreenshotDir = new File(StorageManagerEx.getDefaultPath() + '/' + Environment.DIRECTORY_PICTURES, SCREENSHOTS_DIR_NAME);//add by dickie 
...
// add by hyman 
	...
	private void playVibrator(int time) {

		mVibrator.vibrate(time);
	}    

	private boolean isSilentProfile() {

		return mAudioManager.isSilentMode();//getRingerMode() == AudioManager.RINGER_MODE_SILENT;
	}
    ...
    private void startAnimation(final Runnable finisher, int w, int h, boolean statusBarVisible,
		...
		//add by hyman 
		if(FeatureOption.HQ_GLOBAL_SCREENSHOT_VIBRATOR){
			playVibrator();
		}else{
