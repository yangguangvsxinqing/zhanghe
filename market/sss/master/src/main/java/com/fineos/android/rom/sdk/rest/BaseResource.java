...
//		httpClient.getParams().setParameter(HttpConnectionParams.SO_TIMEOUT, 5 * 1000);
//
...
//		ThemeLog.e("get", "resultClass =" + resultClass);
...
//			ThemeLog.w("get", "response =" + response);
...
//			ThemeLog.w("post", "response =" + response);
//			return GSON.fromJson(response, resultClass);
//		} finally {
//			read.unlock();
//		}
...
//				ThemeLog.e("getRawData", "getRawData response=" + response);
//				ThemeLog.e("getRawData", "getRawData response=" + response.getEntity());
//				HttpEntity entity = response.getEntity();
//				if (entity != null) {
...
//		read.lock();
//		try {
//			byte[] resPose = httpClient.execute(httpGet, handler);
//			ThemeLog.e("getRawData", "getRawData resPose=" + resPose);
//			ThemeLog.e("getRawData", "getRawData resPose=" + resPose.length);
