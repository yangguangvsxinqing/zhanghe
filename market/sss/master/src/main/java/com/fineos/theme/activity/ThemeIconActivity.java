...
public class ThemeIconActivity extends ThemeBaseFragmentActivity {

	@Override
	protected Fragment createFragment(int onlineFlag) {
		return ThemeMixerFragment.newInstance(ThemeData.THEME_ELEMENT_TYPE_ICONS, onlineFlag);
	}
	...
	protected void setCustomActionBarText(TextView tv) {
		// TODO Auto-generated method stub
		if (isonline()) {
			tv.setText(R.string.custom_icon);
		} else {
			tv.setText(R.string.custom_local_icon);
		}
