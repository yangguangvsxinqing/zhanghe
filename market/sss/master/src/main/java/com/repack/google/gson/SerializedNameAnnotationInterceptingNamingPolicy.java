 ...
 * {@link com.repack.google.gson.annotations.SerializedName} annotation is
 * applied to a field then this strategy will translate the name to the
 * {@code serializedName.value()}; otherwise it delegates to the wrapped
