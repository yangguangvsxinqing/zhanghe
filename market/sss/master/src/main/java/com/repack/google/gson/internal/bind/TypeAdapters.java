...
public final class TypeAdapters {
	...
	public static final TypeAdapter.Factory BOOLEAN_FACTORY = newFactory(boolean.class, Boolean.class, BOOLEAN);
	...
	public static final TypeAdapter.Factory BYTE_FACTORY = newFactory(byte.class, Byte.class, BYTE);
	...
	public static final TypeAdapter.Factory SHORT_FACTORY = newFactory(short.class, Short.class, SHORT);
	...
	public static final TypeAdapter.Factory INTEGER_FACTORY = newFactory(int.class, Integer.class, INTEGER);
	...
	public static final TypeAdapter.Factory LONG_FACTORY = newFactory(long.class, Long.class, LONG);
	...
	public static final TypeAdapter.Factory FLOAT_FACTORY = newFactory(float.class, Float.class, FLOAT);
	...
	public static final TypeAdapter.Factory DOUBLE_FACTORY = newFactory(double.class, Double.class, DOUBLE);
	...
	public static final TypeAdapter.Factory CHARACTER_FACTORY = newFactory(char.class, Character.class, CHARACTER);
	...
	public static final TypeAdapter.Factory STRING_BUILDER_FACTORY = newFactory(StringBuilder.class, STRING_BUILDER);
	...
	public static final TypeAdapter.Factory STRING_BUFFER_FACTORY = newFactory(StringBuffer.class, STRING_BUFFER);
	...
	public static final TypeAdapter.Factory INET_ADDRESS_FACTORY = newTypeHierarchyFactory(InetAddress.class, INET_ADDRESS);
	...
	public static final TypeAdapter.Factory CALENDAR_FACTORY = newFactoryForMultipleTypes(Calendar.class, GregorianCalendar.class, CALENDAR);
	...
	public static final TypeAdapter.Factory JSON_ELEMENT_FACTORY = newFactory(JsonElement.class, JSON_ELEMENT);
	...
	public static <TT> TypeAdapter.Factory newEnumTypeHierarchyFactory(final Class<TT> clazz) {
		return new TypeAdapter.Factory() {
			...
			public <T> TypeAdapter<T> create(MiniGson context, TypeToken<T> typeToken) {
				...
				return clazz.isAssignableFrom(rawType) ? (TypeAdapter<T>) new EnumTypeAdapter(rawType) : null;
			}
		};
	}
