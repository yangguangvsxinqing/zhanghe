 ...
 * }
 * 
 * ModifyFirstLetterNamingPolicy policy = new ModifyFirstLetterNamingPolicy(LetterModifier.UPPER);
 * String translatedFieldName = policy.translateName(StringWrapper.class.getField(&quot;stringField&quot;));
 * 
 * assert (&quot;StringField&quot;.equals(translatedFieldName));
 * 
 * String translatedFieldName = policy.translateName(StringWrapper.class.getField(&quot;_stringField&quot;));
 * 
...
final class ModifyFirstLetterNamingPolicy extends RecursiveFieldNamingPolicy {
	...
	/**
	 * Creates a new ModifyFirstLetterNamingPolicy that will either modify the
	 * first letter of the target name to either UPPER case or LOWER case
	 * depending on the {@code modifier} parameter.
	 * 
	 * @param modifier
	 *            the type of modification that should be performed
