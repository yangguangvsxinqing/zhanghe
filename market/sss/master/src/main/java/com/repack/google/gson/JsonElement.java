...
public abstract class JsonElement {
	 ...
	 * Hence it is best to use this method after ensuring that this element is
	 * of the desired type by calling {@link #isJsonObject()} first.
	 * 
	 ...
	 * element is of some other type, a {@link ClassCastException} will result.
	 * Hence it is best to use this method after ensuring that this element is
	 * of the desired type by calling {@link #isJsonArray()} first.
	 * 
	 ...
	 * element is of some other type, a {@link ClassCastException} will result.
	 * Hence it is best to use this method after ensuring that this element is
	 * of the desired type by calling {@link #isJsonPrimitive()} first.
	 * 
	 ...
	 * element is of some other type, a {@link ClassCastException} will result.
	 * Hence it is best to use this method after ensuring that this element is
	 * of the desired type by calling {@link #isJsonNull()} first.
	 * 
