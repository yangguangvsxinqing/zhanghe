 ...
 * String translatedFieldName = policy.translateName(IntWrapper.class.getField(&quot;integerField&quot;));
 * 
...
final class CamelCaseSeparatorNamingPolicy extends RecursiveFieldNamingPolicy {
	 ...
	 * {@code separatorString} between each of the words separated by camel
	 * case.
	 * 
	 * @param separatorString
	 *            the string value to place between words
	 * @throws IllegalArgumentException
	 *             thrown if the {@code separatorString} parameter is null or
	 *             empty.
	 */
