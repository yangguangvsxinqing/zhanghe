...
public class RelatedAppListActivity extends Activity
	...
	private int nAppId;
	private boolean bInflatingRelatedAppList;
	...
	private String nFromWhere = "0";
	private ProgressBar mProgressBar;
	private View mStatus;
	/*************Added-e by JimmyJin for Pudding Project**************/
	public RelatedAppListActivity() {
		
		nStartIndex = 0;
		bInflatingRelatedAppList = false;
		bReachEnd = false;
...
//						}
	...
	private void inflateRelatedAppList() {
		// TODO Auto-generated method stub
		if (bReachEnd || bInflatingRelatedAppList) {
			return;
		}
		bInflatingRelatedAppList = true;
		Request request = new Request(0, Constant.TYPE_APP_RELATED_LIST);
		Object[] params = new Object[2];
		
		params[0] = Integer.valueOf(nAppId);
		...
		mMarketService.getRelatedAppList(request);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*************Added-s by JimmyJin for Pudding Project**************/
	    nFromWhere = String.valueOf(getIntent().getIntExtra("fromWhere", 0));
		/*************Added-e by JimmyJin for Pudding Project**************/
...
//	}
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
    	if (keyCode == KeyEvent.KEYCODE_MENU) {
    		startActivity(new Intent(RelatedAppListActivity.this, OptionsMenu.class));
	...
	public void onItemClick(AdapterView<?> parent, View view,
		...
		if(position < mAppListAdapter.getCount()) {
			...
			/*************Added-s by JimmyJin for Pudding Project**************/
			intent.putExtra("type",Integer.parseInt(nFromWhere));
			/*************Added-s by JimmyJin for Pudding Project**************/
