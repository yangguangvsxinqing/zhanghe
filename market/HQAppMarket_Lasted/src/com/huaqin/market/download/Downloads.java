...
public final class Downloads implements BaseColumns {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://hqdownloads/download");
	...
	public static final String WHERE_RUNNING_OR_COMPLETED= 
	"((status >= '100') AND (status <= '199') AND (visibility IS NULL OR visibility == '0' OR visibility == '1') OR status = '200')";		
